...
def create_zones_trafic():
    ...
    zones_data = [
    {
        ...
        'description': 'Cœur administratif et commercial de Tunis, autour de l’avenue Habib Bourguiba.',
        'coordonnees_zone': {
            "type": "Polygon",
            "coordinates": [[[10.166, 36.800], [10.180, 36.800], [10.180, 36.815], [10.166, 36.815], [10.166, 36.800]]]
        },
        'vitesse_limite': 50,
        'nombre_voies': 4,
    ...
    },
    {
        ...
        'description': 'Zone moderne du Lac 1 avec bureaux, restaurants et centres commerciaux.',
        'coordonnees_zone': {
            "type": "Polygon",
            "coordinates": [[[10.220, 36.830], [10.245, 36.830], [10.245, 36.845], [10.220, 36.845], [10.220, 36.830]]]
        },
        'vitesse_limite': 60,
        'nombre_voies': 4,
        'sens_circulation': 'bidirectionnel',
    },
    {
        ...
        'description': 'Quartier résidentiel et calme situé au nord de Tunis.',
        'coordonnees_zone': {
            "type": "Polygon",
            "coordinates": [[[10.170, 36.850], [10.200, 36.850], [10.200, 36.870], [10.170, 36.870], [10.170, 36.850]]]
        },
        'vitesse_limite': 40,
        'nombre_voies': 2,
        'sens_circulation': 'bidirectionnel',
    ...
    {
        'nom': 'La Marsa',
        'type_zone': 'zone_touristique',
        'description': 'Zone côtière touristique, connue pour ses plages et ses restaurants.',
        'coordonnees_zone': {
            "type": "Polygon",
            "coordinates": [[[10.310, 36.870], [10.330, 36.870], [10.330, 36.890], [10.310, 36.890], [10.310, 36.870]]]
        },
        'vitesse_limite': 50,
        'nombre_voies': 3,
        'sens_circulation': 'bidirectionnel',
    },
    {
        'nom': 'Ezzahra',
        'type_zone': 'zone_residentielle',
        'description': 'Ville de la banlieue sud, principalement résidentielle.',
        'coordonnees_zone': {
            "type": "Polygon",
            "coordinates": [[[10.320, 36.700], [10.340, 36.700], [10.340, 36.720], [10.320, 36.720], [10.320, 36.700]]]
        },
        'vitesse_limite': 40,
        'nombre_voies': 2,
        'sens_circulation': 'bidirectionnel',
    ...
    {
        'nom': 'Rocade X de Tunis',
        'type_zone': 'rocade',
        'description': 'Grande rocade reliant les différentes zones de Tunis.',
        'coordonnees_zone': {
            "type": "Polygon",
            "coordinates": [[[10.100, 36.780], [10.250, 36.780], [10.250, 36.790], [10.100, 36.790], [10.100, 36.780]]]
        },
        'vitesse_limite': 90,
        'nombre_voies': 6,
        'sens_circulation': 'bidirectionnel',
